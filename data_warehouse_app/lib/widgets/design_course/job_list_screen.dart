...
class JobListScreen extends StatefulWidget {
  const JobListScreen(this.categoryName, this.jobList, this.listJobCached);

  final String categoryName;
  final Future<List<Job>> jobList;
  final List<Job> listJobCached;
      ...
      return Container(
        ...
        child: Scaffold(
          ...
          body: ListView.builder(
              itemCount: widget.listJobCached.length,
              itemBuilder: (BuildContext context, int index) {
                return ConstrainedBox(
                    constraints: new BoxConstraints(
                      minHeight: 15,
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            ListTile(
                              leading: CachedNetworkImage(
                                imageUrl: widget.listJobCached[index].companyLogo,
                                // imageBuilder: (context, imageProvider) =>
                                //     Container(
                                //   height: 100,
                                //   width: 100,
                              ...
                              title: Text(widget.listJobCached[index].title.trim(),
                                  maxLines: 3,
                                  overflow: TextOverflow.ellipsis,
                                  style: AppTheme.title),
                              subtitle: Text(
                                  widget.listJobCached[index].companyName.trim(),
                                  maxLines: 3,
                                  overflow: TextOverflow.ellipsis,
                                  style: AppTheme.subtitle),
                              onTap: () => {moveTo(widget.listJobCached[index])},
                            ),
                            const SizedBox(
                              height: 16,
                            ),
